...
indentation testing configuration, a pin was attached to the movable cross head holding grip, 
...
\begin{figure}%
    \centering
   \subfloat[\centering Indentation test configuration with a \SI{500}{\newton} load cell \label{fig:500loadcell}]{{\includegraphics[width=6.5cm]{Images/Experiment/firstexperiment}}}%
   \qquad
   \subfloat[\centering Indentation test configuration with a \SI{10}{\newton} load cell \label{fig:10loadcell}]{{\includegraphics[width=6.5cm]{Images/Experiment/firstexpotherload}}}%
...
on the lower part of the specimen an ellipsoid with a minor radius $r_{l1} = \SI{5}{\milli \m}$ 
and a major radius $r_{l2} = \SI{10}{\milli \m}$ was removed (Fig. %make picture with removed). 
The specimen was made from a YNU laboratory member, by 3D printing a mold with the wanted dimensions 
and filling it with resin liquid. Additionally, it was left to cure for around \SI{30} hours. 
