   ...
   \qquad
    \begin{tikzpicture}[scale=1]
        \begin{axis}[
            ...
            grid = major,
            legend pos= north west]
            \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Middle Point/MPI38mm.dat};
            \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Middle Point/MPII4mmtotalap.dat};
   ...
   \subfloat[\centering Experimental model I: Total force reaction - indentation depth graph \label{fig:luIexp}]{{
        \begin{tikzpicture}[scale=0.75]
            \begin{axis}[
                ...
                grid = major,
                legend pos= north west]
                \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Loadunload/LI4mm.dat};
                \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Loadunload/UI4mm.dat};
   ...
   \subfloat[\centering Experimental model II: Force reaction components - indentation depth graph \label{fig:luIIexp}]{{
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            grid = major,
            legend pos= north west]
            \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Loadunload/LII4mm.dat};
            \addplot+[smooth, no markers] table [y=$Force$, x=Def]{Table/Loadunload/UII4mm.dat};
