...
\begin{enumerate}
    ...
    \item Nonlinear elasticity was observed and hysteresis can be neglected, as the chang-es observed with the different loading speeds were not significant enough to affect the initial results.
