...
It can be conlcuded, that the results from this nearby point support the 
findings from the Middle point test, indicating that the material behavior is 
...
Nonetheless, these differences are not significant enough to affect the overall conclusions.\\
