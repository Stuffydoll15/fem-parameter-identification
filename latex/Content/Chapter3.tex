...
The second level introduces the use of more material parameters. For this level a 
Neo-Hookean model was used to describe the material behavior.

The elastic strain energy potential function for the Neo-Hookean material model is given with
\begin{align}
...
\begin{align*}
    J = 1 \, ,
\end{align*} 
and the second term in strain energy potential $W$ becomes zero \cite{Pence2015}. Additionally, related to the incompressibility parameter 
$D_1$ the initial bulk modulus 
\begin{align}
    K = \frac{2}{D_1} \, ,
\end{align}
can be defined. 
