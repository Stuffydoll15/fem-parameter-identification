...
configuration was manufactured months before (\ref{section:expmod1}), it is possible that the aging 
...
Figure %crear graph de los speeds
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{10}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{10}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{20}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{20}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{30}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{30}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{50}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{50}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{75}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{75}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[scale=0.75]
        \begin{axis}[
            ...
            \legend{Load \SI[per-mode = symbol]{100}{\milli \m\per \minute}, Unload \SI[per-mode = symbol]{100}{\milli \m\per \minute}}
        \end{axis}
    \end{tikzpicture}
...
In the case of ultra-soft polyurethane, it is likely that the hysteresis is 
...
is not impactful for the first level of the determination of the material parameters 
