...
%chatgptBuilding on the results of the previous section, we conducted an indentation test at the same point on the surface of the ellipsoid specimen, but this time in a loading-unloading case. During this test, we observed a hysteresis phenomenon, which is indicative of a nonlinear and time-dependent mechanical behavior in the material. In this section, we will discuss the details of this loading-unloading test and analyze the implications of the observed hysteresis.
%speak about why this usecase was chosen
%for experimental model 1
%change in the experiment setup
%change in speeds
%  experimental results of loading and unloading at loading speeds 10, 20, 30, 50, 75, and 100 [mm/min].
%for experimental model 2
