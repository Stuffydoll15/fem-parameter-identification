...
a Young's Modulus of $E_r = \SI{35}{\milli \m}$.
...
smoother and more controlled indentation process.
...
The second experimental model offers some advantages over the first model. Specifically, 
it enables not only the measurement of the total force reaction, but also the analysis 
