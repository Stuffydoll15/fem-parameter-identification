...
Moreover, indentation presents a bigger advantage in cases where it is not possible to load
test specimens in a more conventional way \cite{Bergström2015}.   



As some materials, e.g. biomaterials do not always 
...
The indentation testing setup is described as followed: As shown in Fig. \ref{fig:Nanoindentation} 
