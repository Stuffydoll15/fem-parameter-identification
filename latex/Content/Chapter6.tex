...
Defining satisfactory performance metrics values required a multi-dimensional approach. 
...
wether these simulations met or surpassed the established error threshold. If the simulation did not meet the threshold, 
...
%The test specimen used for this experiment was an ultra-soft polyurethane resin. 
%As shown in Fig.. the specimen possesses an ellipsoidal form with 
...
% The specimen was tested in an indentation test configuration with a tensile/compression machine.
